...
<p align="center">
Completion data has been extracted from the original KTIGCC completion file. We are using a JSON structure to hold generic, editor-neutral completion data, which is made available to the editors via a completion data backend class. Each editor backend has it's own corresponding completion data adapter. As of v0.3.1-alpha, we have the adaptor for QScintilla working.  
</p>
<p align="center">
